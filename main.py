...
Returns:
  ...
  with open(filename, 'r') as infile:
    ...
    # Read in the csv file and skip the first 2 lines (header). This may change
    # depending on the quarter; adjust the number to reflect the number of lines
    # to skip
  ...
  result = ''.join(mails)
  print("Parsed TSV file. Number of tutors: {}.".format(len(mails)))
